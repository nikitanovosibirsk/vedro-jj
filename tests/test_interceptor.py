...
@pytest.mark.asyncio
async def test_interceptor_middleware(req: Request, handler: Handler, app: App):
...
@pytest.mark.asyncio
async def test_interceptor_middleware_sync(req: Request, handler: Handler, app: App):
    mock = Mock(Response)
...
@pytest.mark.asyncio
async def test_interceptor_middleware_async(req: Request, handler: Handler, app: App):
    mock = Mock(Response)
...
@pytest.mark.asyncio
async def test_interceptor_middleware_no_response(req: Request, handler: Handler, app: App):
...
@pytest.mark.asyncio
async def test_interceptor_middleware_incorrect_response(req: Request, handler: Handler, app: App):
